...
keymap("n", "<F1>", "<Cmd>!./.nvim/build.sh cmake exit<CR>", opts)
keymap("n", "<F2>", "<Cmd>!./.nvim/build.sh build exit<CR>", opts)
keymap("n", "<F3>", "<Cmd>!./.nvim/build.sh run exit<CR>", opts)
keymap("n", "<F4>", "<Cmd>!./.nvim/python_run.sh exit<CR>", opts)
...
keymap("i", "<F1>", "<Cmd>!./.nvim/build.sh cmake exit<CR>", opts)
keymap("i", "<F2>", "<Cmd>!./.nvim/build.sh build exit<CR>", opts)
keymap("i", "<F3>", "<Cmd>!./.nvim/build.sh run exit<CR>", opts)
keymap("i", "<F4>", "<Cmd>!./.nvim/python_run.sh exit<CR>", opts)
