...
keymap("n", "<F1>", "<Cmd>!./build.sh cmake exit<CR>", opts)
keymap("n", "<F2>", "<Cmd>!./build.sh build exit<CR>", opts)
keymap("n", "<F6>", "<Cmd>!./build.sh run exit<CR>", opts)
keymap("n", "<F3>", "<Cmd>!./python_run.sh exit<CR>", opts)
...
keymap("i", "<F1>", "<Cmd>!./build.sh cmake exit<CR>", opts)
keymap("i", "<F2>", "<Cmd>!./build.sh build exit<CR>", opts)
keymap("i", "<F6>", "<Cmd>!./build.sh run exit<CR>", opts)
keymap("i", "<F3>", "<Cmd>!./python_run.sh exit<CR>", opts)
