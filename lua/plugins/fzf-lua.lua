...
return {
  ...
  keys = {
      ...
      end, mode = "n", desc = "Command history" },
      { "tl", function()
      ...
      end, mode = "n", desc = "Live grep" },
      { "td", function()
          require("fzf-lua").diagnostics_workspace()
      end, mode = "n", desc = "Workspace diagnostics" },
      { "tb", function()
          require("fzf-lua").buffers()
      end, mode = "n", desc = "Buffers" },
      { "tg", function()
          require("fzf-lua").grep()
      end, mode = "n", desc = "Grep" },
      { "tr", function()
          require("fzf-lua").resume()
      end, mode = "n", desc = "Resume" },
      { "<leader>f", function()
          require("fzf-lua").files({
      ...
      end, mode = "n", desc = "Find files" },
      { "<leader>tc", function()
          diff_current()
      end, mode = "n", desc = "Telescope compare with current" },
      { "<leader>tC", function()
          diff_files()
      end, mode = "n", desc = "Telescope compare 2 files" },
  }
}
